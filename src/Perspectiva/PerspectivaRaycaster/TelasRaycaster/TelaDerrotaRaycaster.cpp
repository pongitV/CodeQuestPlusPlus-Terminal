...
public:
    CenaDerrota3D(Personagem* jogador, int turnos, int dano) 
        ...
        tela3D = RaycasterRenderizadorCombate::renderizarQuadro("Cemiterio", jogadorAtual, vazio);
...
void TelaDerrotaRaycaster::exibir(Personagem* jogadorAtual, int, int, int totalDeDanoCausado, int, int, int turnosCombate)
{
