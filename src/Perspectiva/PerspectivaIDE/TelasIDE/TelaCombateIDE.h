...
public:
    ...
    static void exibirDrops(const std::vector<std::string>& drops);
    static int exibirMenuAcoes(Personagem* jogador, const std::vector<Personagem*>& inimigos);
    static int exibirSelecaoAlvo(const std::vector<Personagem*>& inimigos);
    static void exibirTurno(Personagem* personagem, const std::vector<Personagem*>& inimigos, int turno);
    static void exibirLogCombateTurnal(const std::vector<std::string>& mensagens);
    static void exibirMorteInimigo(const std::string& nomeInimigo, int xpGanho, const std::vector<std::string>& drops);
    static void exibirEfeitosAtivos(Personagem* personagem);
    static int exibirSelecaoItem(Personagem* jogador, int categoria);
    static int exibirSelecaoEscudo(Personagem* jogador, const std::vector<Item*>& escudos);
    static void exibirPosturaDefensiva(Personagem* jogador, const std::string& nomeEscudo);
    static void exibirDesequilibrioDefesa(Personagem* jogador);
    static void exibirMensagemCombate(const std::string& mensagem, int cor);
};
