...
void Mapa::iniciarExploracao() 
{
    ...
    while (jogando && jogador->obterVida() > 0) 
    {
        ...
        if (celula != '#' && celula != '~') 
        {
            ...
            else if (celula == '^' && layout[proximoY][proximoX+1] == 'C' && !emSubMapa)
            {
            ...
            else if (celula == '^' && layout[proximoY][proximoX+1] == 'S' && emSubMapa)
            {
            ...
            else if (celula == '^' && layout[proximoY][proximoX+1] == 'L' && !emSubMapa)
            {
                mapaGeralSalvo = layout;
                anteriorX = jogadorX;
                anteriorY = jogadorY;
