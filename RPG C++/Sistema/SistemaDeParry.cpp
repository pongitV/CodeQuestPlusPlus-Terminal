...
bool SistemaDeParry::tentarParry(Personagem* atacante, int danoMitigado, int& quantidadeDeDanoReduzido) 
{
...
bool SistemaDeParry::executarMinigame(int quantidadeDeNumerosParaDigitar, int tempoLimiteEmSegundos, int& quantidadeDeDanoReduzido) 
{
