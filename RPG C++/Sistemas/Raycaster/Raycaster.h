...
public:
    ...
    static char iniciarExploracao3D(const std::vector<std::string>& matrizDoMapa, float& jogadorX, float& jogadorY, float& anguloVisao, const std::string& tituloMapa, Personagem* jogador, int& outHitX, int& outHitY, bool animarEntrada = true);
};
