...
std::string ClasseClone::obterNomeClasse() const { return "Lacaio"; }
...
std::string ClasseClone::obterNomePassivaClasse() const { return ""; }
std::string ClasseClone::obterDescricaoPassivaClasse() const { return ""; }
