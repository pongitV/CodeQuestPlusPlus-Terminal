...
#include "../../Inventario/InventarioConsumiveis/ItemConsumivel.h"
...
#include "../../NPCs/Morgana/NPCMorgana.h"
...
#include "../Mapa3Reino/Mapa3Reino.h"
        ...
        void processar(ContextoInteracaoFloresta& ctx) override {
            if (ctx.self->tituloDoMapaAtual == "LABIRINTO SUBTERRANEO") {
                ...
                if (opcao == 1) {
                    ...
                    SistemaIndex::instancia().registrarItemVisto("Pocao de Cura (30%VM)");
                    }
                ...
                SistemaIndex::instancia().registrarItemVisto(nomeBuff);
                ...
                SistemaIndex::instancia().registrarItemVisto("Pedra magica de upgrade");
