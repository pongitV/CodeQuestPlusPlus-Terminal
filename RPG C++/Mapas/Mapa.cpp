                ...
                do {
                    ...
                    else if (opcaoEscolhidaNoMenuJogador == "V" || opcaoEscolhidaNoMenuJogador == "v") 
                    {
                        ...
                        do {
                            ...
                            if (codigoVenda != "0") {
                                Item* itemParaVenda = jogadorAtual->obterInventario()->buscarItemPeloCodigoDigitado(
                                ...
                                if (itemParaVenda) {
                                    ...
                                    jogadorAtual->obterInventario()->adicionarOuroAoInventario(precoVenda);
                                    jogadorAtual->obterInventario()->removerItemDoInventarioPeloNome(nomeItemVenda);
