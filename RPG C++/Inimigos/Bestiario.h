...
public:
    ...
    const BestiarioEnemyInfo* obterInfo(const std::string& nomeInimigo) const;
...
private:
    Bestiario();
    std::map<std::string, BestiarioEnemyInfo> inimigosBase;
